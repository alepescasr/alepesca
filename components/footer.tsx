        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://www.instagram.com/alepescasr" target="_blank" className="text-primary-lighter hover:text-accent transition-colors duration-300">
                <Instagram size={20} />
              </Link>
              <Link href="#" className="text-primary-lighter hover:text-accent transition-colors duration-300">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-primary-lighter hover:text-white transition-colors duration-300">
                  Sobre Nosotros
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-primary-lighter hover:text-white transition-colors duration-300">
                  Términos y Condiciones
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-primary-lighter hover:text-white transition-colors duration-300">
                  Política de Privacidad
                </Link>
              </li>
              <li>
                <Link href="/shipping" className="text-primary-lighter hover:text-white transition-colors duration-300">
                  Envíos y Devoluciones
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-primary-lighter hover:text-white transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center text-primary-lighter">
                ...
                <span>Av.Libertador 482, San Rafael, Mendoza</span>
              </li>
              <li className="flex items-center text-primary-lighter">
