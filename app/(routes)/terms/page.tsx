      ...
      <div className="py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none">
          ...
          <p className="text-lg mb-6">
            Al acceder y utilizar el sitio web de AlePesca, usted acepta estos términos y condiciones en su totalidad. Si no está de acuerdo con estos términos, por favor no utilice nuestro sitio web.
          </p>
          ...
          <p className="text-lg mb-6">
            Es responsabilidad del usuario mantener la confidencialidad de su cuenta y contraseña. AlePesca no será responsable por cualquier uso no autorizado de su cuenta.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">6. Propiedad Intelectual</h2>
          <p className="text-lg mb-6">
            Todo el contenido incluido en este sitio, como textos, gráficos, logos, imágenes, clips de audio, descargas digitales y compilaciones de datos, es propiedad de AlePesca o sus proveedores de contenido y está protegido por las leyes argentinas e internacionales.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">7. Limitación de Responsabilidad</h2>
          <p className="text-lg mb-6">
            AlePesca no será responsable por daños indirectos, incidentales o consecuentes que resulten del uso o la imposibilidad de usar nuestros servicios.
          </p>
